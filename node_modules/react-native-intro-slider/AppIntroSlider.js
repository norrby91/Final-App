...
export default class AppIntroSlider extends React.Component {
  ...
  _renderItem = flatListArgs => {
    ...
    console.log("_renderItem in AppIntroSlider: ", props);

    return (
      <View style={{ width, flex: 1 }}>
        {this.props.renderItem ? (
          this.props.renderItem(props.item)
        ) : (
          <DefaultSlide bottomButton={props.bottomButton} {...props} />
        )}
      </View>
    );
  };
  ...
  _renderOuterButton = (content, name, onPress) => {
    ...
    return (
      <View style={!this.props.bottomButton && style}>
        <TouchableOpacity
          onPress={onPress}
          style={this.props.bottomButton ? styles.container : this.props.buttonStyle}
        >
          {content}
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  paginationDots: {
    ...
    alignItems: 'center',
    //backgroundColor: 'pink', //visualização
  },
  dot: {
    width: 10,
    height: 10,
  ...
  bottomButton: {
    flex: 1,
    backgroundColor: 'rgba(0, 0, 0, .3)', //default - alterado com uma props
    alignItems: 'center',
    justifyContent: 'center',
  },
  buttonText: {
    //backgroundColor: 'transparent',
    color: 'white', //default - alterado com uma props
    fontSize: 18, //default - alterado com uma props
    paddingVertical: 15,
    paddingHorizontal: 30,
    //backgroundColor: 'red', //visualização
  },
});
