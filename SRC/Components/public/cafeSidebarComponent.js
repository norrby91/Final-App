                ...
                <Content >
                    <List>
                        <ListItem style={{ flexDirection: "column", marginLeft: 0, backgroundColor: '#F1F1F1', borderColor: '#F1F1F1' }}>
                            ...
                            <Text style={{ fontSize: 18 / PixelRatio.getFontScale(), fontWeight: "bold" }}>UU Quick Order</Text>
                            <Text style={{ fontSize: 12 / PixelRatio.getFontScale() }}>Please view your orders</Text>
                        </ListItem>
                        ...
                        <ListItem onPress={this.navigateToScreen('Menus')} style={styles.listItemStyle}>
                            <Left>
                                <View style={styles.listItemWrapperStyle}>
                                    <View style={{ flex: 0.2 }}>
                                    ...
                                    <View style={{ flex: 1, paddingLeft: 20, justifyContent: 'center' }}>
                                        <Text style={styles.listItemTextStyle}>Menus</Text>
                                    </View>
                                </View>
                            </Left>
                            <Right>
                        ...
                        <ListItem onPress={this.navigateToScreen('Drivers')} style={styles.listItemStyle}>
                            <Left>
                                <View style={styles.listItemWrapperStyle}>
                                    <View style={{ flex: 0.2 }}>
                                        <FontAwesome5 name="users" size={20} color="#888" />
                                    </View>
                                    <View style={{ flex: 1, paddingLeft: 20, justifyContent: 'center' }}>
                                        <Text style={styles.listItemTextStyle}>Drivers</Text>
                                    </View>
                                </View>
                            </Left>
                            <Right>
                        ...
                        <ListItem onPress={this.navigateToScreen('CafeOrders')} style={styles.listItemStyle}>
                            <Left>
                                <View style={styles.listItemWrapperStyle}>
                                    <View style={{ flex: 0.2 }}>
                                        <FontAwesome5 name="users" size={20} color="#888" />
                                    ...
                                    <View style={{ flex: 1, paddingLeft: 20, justifyContent: 'center' }}>
                                        <Text style={styles.listItemTextStyle}>Orders</Text>
                                    </View>
                                </View>
                            </Left>
                            <Right>
