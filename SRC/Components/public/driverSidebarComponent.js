                ...
                <Content >
                    <List>
                        <ListItem style={{ flexDirection: "column", marginLeft: 0, backgroundColor: '#F1F1F1', borderColor: '#F1F1F1' }}>
                            ...
                            <Text style={{ fontSize: 18 / PixelRatio.getFontScale(), fontWeight: "bold" }}>Welcome Driver</Text>
                        ...
                        <ListItem onPress={this.navigateToScreen('DriverOrders')} style={styles.listItemStyle}>
                            <Left>
                                <View style={styles.listItemWrapperStyle}>
                                    <View style={{ flex: 0.2 }}>
